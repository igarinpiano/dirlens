...
| `Fatal Python error: Failed to import encodings module` | `python3` が指している実体（pyenv/mise/conda管理のPython等）がサンドボックスから読み取れない | システムのPython3を明示的に指定する: `/usr/bin/python3 <パス> --agent`（macOS） |
